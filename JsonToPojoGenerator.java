/*
* JsonToPojoGenerator.java
*
* @author sri369c
*/
package com.sri.generator;
...
public class JsonToPojoGenerator {
  ...
  private static final String FILENAME_NO_EXTENSION = "RunDetail";
  private static final String OUTPUT_PACKAGE_NAME = "com.generated." + FILENAME_NO_EXTENSION;
  
  public static void main (String[] args) {

    File inputJson = new File("C:\\MyWork\\eclipse-ide-workspace-im\\JsonToPojoGenerator\\src\\main\\resources\\" + FILENAME_NO_EXTENSION + ".json");
    File outputPojoDirectory = new File("C:\\MyWork\\eclipse-ide-workspace-im\\JsonToPojoGenerator\\src\\main\\java\\");
